...
ARM_Dynarmic::ARM_Dynarmic()
    : cb(std::make_unique<ARM_Dynarmic_Callbacks>(*this)),
      jit(std::make_unique<Dynarmic::A64::Jit>(Dynarmic::A64::UserConfig{cb.get(), reinterpret_cast<void**>(Kernel::g_current_process->vm_manager.page_table.fast_pointers.data()), Memory::PAGE_TABLE_NUM_ENTRIES})) {
    ARM_Interface::ThreadContext ctx;
